...
st.set_page_config(page_title="Torendo", layout="wide")
...
tab_overview, tab_chart, tab_risk, tab_corr, tab_liquidity, tab_portfolio, tab_backtest, tab_ai = st.tabs(
    ["Overview", "Chart", "Risk & Returns", "Correlation", "Liquidity", "Portfolio", "Backtest", "💬 AI Chat"]
)
