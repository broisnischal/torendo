...
with st.spinner("Fetching price data..."):
    for sym in selected_symbols:
        try:
            data[sym] = load(sym, resolution, start_ts, end_ts)
...
tab_overview, tab_chart, tab_risk, tab_corr, tab_portfolio, tab_backtest = st.tabs(
    ["Overview", "Chart", "Risk & Returns", "Correlation", "Portfolio", "Backtest"]
)
